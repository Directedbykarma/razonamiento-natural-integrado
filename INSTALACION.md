...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Directedbykarma/razonamiento-natural-integrado/master/scripts/setup.sh)"
```

### Opción 2: Descargar y ejecutar
```bash
# 1. Descargar script
curl -O https://raw.githubusercontent.com/Directedbykarma/razonamiento-natural-integrado/master/scripts/setup.sh
